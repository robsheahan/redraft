...
import { type SkillFamily, SKILL_RATING_GUIDANCE } from '../data/skill-taxonomy.js';
...
export function buildInsightsSignalsPrompt(opts: {
  ...
  const system = isMaths ? [
    ...
    ``,
    `RULES:`,
    `- Assess the maths skill dimensions in the tool (comprehension/method, procedural accuracy, reasoning/justification, notation, communication of working, and interpretation/application) from the working.`,
