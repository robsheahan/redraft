...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // max_tokens kept tight to avoid 60s Vercel timeout — Pass 1 output is
    // typically 1500-2500 tokens; 3000 leaves headroom without risking a
    // runaway long generation that pushes the whole pipeline past 60s.
